			...
			dateFormat:'yy-mm-dd'
				...
				<div class="features_items">
					...
					<?php if($perkategori == null){?>
						...
						<h2 class="heading">Tidak ada Produk</h2>
						</div>
					<?php }else{?>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										...
										<a class="example-image-link"href="<?php echo base_url().$row->image;?>"data-lightbox="example-1"data-title="<?php echo $row->nama_produk;?>">
											...
											<a href="<?php echo site_url('home/detil_produk/'.$row->id_produk);?>" class="btn btn-default add-to-cart"><i class="fa fa-eye"></i> Detil</a>
											...
											<a href="<?php echo site_url('member/login');?>" class="btn btn-default add-to-cart"onclick="alert('Anda Belum login sebagai Member !')"><i class="fa fa-eye"></i> Detil</a>
											<?php }?>
