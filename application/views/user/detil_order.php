		...
		<div class="row">	
			<div class="col-sm-3">
				<div class="shopper-info">
					...
					<form>
						<input type="text" placeholder="Nomor : <?php echo $row->no_order;?>">
						<input type="text" placeholder="Tgl Order : <?php echo $row->tgl_order;?>">
					</form>
					<?php endforeach;?>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="shopper-info">
					<?php foreach($order as $row):?>
					<form>
						<input type="text" placeholder="Pemesan : <?php echo $row->nama_member;?>">
						<input type="text" placeholder="No Telp : <?php echo $row->no_telp;?>">
					</form>
					<?php endforeach;?>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="shopper-info">
					<?php foreach($order as $row):?>
					<textarea name="message"  placeholder="Alamat : <?php echo $row->alamat;?>" rows="3"></textarea>
