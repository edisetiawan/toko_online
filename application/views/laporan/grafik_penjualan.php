    	...
    	<div class="col-xs-12">
        	<div class="box">
				...
				<?php foreach($tahun as $row):?>
                  <h3 class="box-title">Grafik Penjualan <?php echo $row->tahun;?></h3>
				<?php endforeach;?>
                </div><!-- /.box-header -->
                <div class="box-body">	
				<script type="text/javascript">
					...
					{
						document.location =  '<?php echo site_url(); ?>admin/grafik/grafik_penyewa/' + val;
					}
				</script>
				 <?PHP echo $chart; ?>
					<div class="pull-right">
					<form action="<?php echo site_url('admin/grafik/grafik_penjualan');?>" method="post">
